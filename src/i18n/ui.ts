...
export const ui = {
  ...
  id: {
    ...
    "home.npmjs.seeAll": "Lihat semua paket",
    ...
    "home.image.caption":
      "Ketika tidak sedang coding, saya biasanya mendaki gunung.",
